...
function CreateRoom() {
    ...
    function handleSubmit(event) {
        ...
        if (room_number && room_type && price_per_night && (availability === '0' || availability === '1')) {
            axios.post('http://localhost:8081/create', {room_number, room_type, price_per_night, availability})
                .then(res => {
                    console.log(res);
                    navigate("/admin");
        ...
        <div className="d-flex vh-100 bg-primary justify-content-center align-items-center">
            <div className="w-50 bg-white rounded p-3">
                <form onSubmit={handleSubmit}>
                    <h2 className="text-center mb-4">Dodaj pokój</h2>
                    <div className="mb-2">
